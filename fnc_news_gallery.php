...
function display_news_image() {
    ...
    while ($stmt -> fetch()) {
        ...
        $display_image .= '<img src="../news_photos/' .$photo_filename_from_db .'" alt="' .$photo_alttext_from_db .'" class="thumb" data-fn="' .$photo_origname_from_db .'" data-id=' .$photo_id_from_db .'">';
