...
<body>
  ...
  <p>See leht on valminud õppetöö raames!</p>
    <h2><p style="color:yellow">Logi sisse</p></h2>
    </div>
    ...
    <p>Loo endale <a href="add_user.php">kasutajakonto!</a></p>
		<p>Registreerunud kasutajatel on võimalus <a href="add_news.php">lisada uudiseid</a>, <a href="show_news.php">neid lugeda</a>, <a href="upload_photo.php">pilte üles laadida</a> ning neid <a href="gallery.php">galeriist vaadata.</a> Selleks tuleb sisse logida!</p>
    <?php
        echo $timehtml;
